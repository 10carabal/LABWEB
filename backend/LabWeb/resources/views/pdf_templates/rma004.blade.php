...
<head>
    ...
    @if (!empty($sheets))
        <title>RMA004 - {{Carbon\Carbon::now()->format("Ymd_His")}}</title>
    @else
        <title>RMA004</title>
    @endif
...
<body>
    ...
    <div class="sheet_container">
        <ul class="data_list">
            ...
            <li>
        <b>FREC MENTO PREVENTIVO: </b>
                <span>{{$sheet->FREC_MENTO_PREVENTIVO}}</span>
            </li>
            <li>
                <b>FECHA EJECUCION: </b>
            ...
            <li>
                <b>RESPONSABLE MANTENIMIENTO: </b>
                <span>{{$sheet->RESPONSABLE_MANTENIMIENTO}}</span>
            </li>
            <li>
            ...
            <li>
                <b>COSTO MANTENIMIENTO: </b>
                <span>{{$sheet->COSTO_MANTENIMIENTO}}</span>
            </li>
            <li>
